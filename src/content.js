...
// loop through c to see if they are p elements or pre elements
    ...
    main.addEventListener('DOMSubtreeModified', function () { // generated by ChatGPT
        ...
        //clearTimeout(stop_saving)
        if (!timer_started) {
            interval = setInterval(save_page, 2000);
        }
        //stop_saving  = setTimeout(() => {clearInterval(interval); console.log('stopped')}, 10000) // stops saving after 10 seconds of no changes - theoretically; doesn't work
        timer_started = true;
    });
