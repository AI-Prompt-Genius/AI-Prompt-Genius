        ...
        <div className="modal-box max-w-[1000px] h-full">
          ...
          {page === 2 && (
            <div className="p-4">
              ...
              <p className="text-gray-600 mb-4">
                AI Prompt Genius is now self-contained. You can access it
                anywhere by clicking the extension icon or opening the sidebar
                (Chrome 116+). Work with any AI model of your choice.
              </p>

              <Head4>More robust import and cloud syncing features</Head4>
              <p>
                You can mass import prompts using a CSV template. Cloud syncing
                is now more reliable and prominent.
              </p>
          ...
          {page === 3 && (
            <div className="p-4">
              ...
              <p>
                If you want to continue using the legacy categories, you can
                choose to import them as tags or folders.
              </p>
            </div>
          )}
          {page === 4 && (
            <div className="p-4">
              <div className="p-4">
                ...
                <Head4></Head4>{" "}
                {/* Assuming you want to keep this empty Head4 here */}
              </div>
            </div>
          )}
