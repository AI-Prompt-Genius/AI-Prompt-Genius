                ...
                <div className="modal-box max-w-[1000px] h-full">
                    ...
                    {page === 2 &&
                        <div className="p-4">
                            ...
                            <p className="text-gray-600 mb-4">AI Prompt Genius is now self-contained. You can access it anywhere by clicking the extension icon or opening the sidebar (Chrome 116+). Work with any AI model of your choice.</p>
                            ...
                            <p className={"text-gray-600 mb-4"}>You can download a copy of your data <span className={"link-primary link"}> JSON here.</span> You can <a className="link link-primary" target={"_blank"} href={""}> click here</a> to learn more about how to continue using these features.</p>
                        </div>
                    }
                    {page === 3 &&
                        <div className="p-4">
                            <div className={"flex align-middle"}>
                                <div className={"inline mr-3"}><Head4>Import categories as</Head4></div>
                    ...
                    {page === 4 &&
                        <div className="p-4">
                            <div className="p-4">
                                ...
                                <Head4></Head4> {/* Assuming you want to keep this empty Head4 here */}
                            </div>
                    ...
                    <div className={"absolute bottom-0 mb-2 p-3"}>
                        ...
                        <button disabled={page !== MAX_PAGE_NUM} className={"btn disabled:hidden"}>Close</button>
                    </div>
                </div>
            </div>
        </>
