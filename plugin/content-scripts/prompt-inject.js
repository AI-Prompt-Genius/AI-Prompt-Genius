function bigWrapper() {
  function main() {
    chrome.storage.local.get({ prompts: [] }, function (result) {
      ...
      document.body
        ...
        .setAttribute("id", "prompts_storage");
    ...
    setTimeout(
      () =>
        injectScript(
          chrome.runtime.getURL("content-scripts/prompts.js"),
          "body",
        ),
      500,
    );
  ...
  function addUserPromptListener() {
    document
      .getElementById("userPrompts")
      .addEventListener("click", openPrompts);
